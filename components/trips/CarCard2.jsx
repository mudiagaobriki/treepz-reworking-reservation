        ...
        <div className='flex flex-col flex-start rounded-xl tz-shadow tz-border-light'>
            <div className="self-stretch">
                ...
                <div id="controls-carousel" className="relative w-full" data-carousel="slide">
                    {/*Carousel wrapper*/}
                    <div className="relative h-48 w-full overflow-hidden rounded-t-lg px-3">
                        <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                            <Image src={carImage} width={320} height={208} className="absolute block h-full w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                        </div>
