...
const AccountSideBar = ({page}) => {
    ...
    return (
        <div className="inline-flex flex-col items-start w-64 bg-white gap-3">
            <Link href="/account/profile" className={`flex items-center gap-2 p-3 w-full rounded-lg ${page == 'profile' && 'tz-bg-orange'}`}>
            ...
            <Link href="/account/security-settings" className={`flex items-center gap-2 p-3 w-full rounded-lg ${page == 'security-settings' && 'tz-bg-orange'}`}>
            ...
            <Link href="/account/notifications" className={`flex items-center gap-2 p-3 w-full rounded-lg ${page == 'notifications' && 'tz-bg-orange'}`}>
            ...
            <Link href="/account/bank-details" className={`flex items-center gap-2 p-3 w-full rounded-lg ${page == 'bank-details' && 'tz-bg-orange'}`}>
            ...
            <Link href="/account/referals" className={`flex items-center gap-2 p-3 w-full rounded-lg ${page == 'referals' && 'tz-bg-orange'}`}>
