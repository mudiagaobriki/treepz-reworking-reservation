...
const BankCard = ({accountNumber, accountName, bankName}) => {
        ...
        <div className="w-80 h-52 px-4 pt-8 pb-5 rounded-lg tz-shadow tz-border-cc tz-bg-light-2">
            <div className="flex justify-between items-start w-full h-1/2 mb-2">
                <div className="flex items-center">
                    ...
                    &nbsp;
                    <div className="text-sm tz-text-gray uppercase">{bankName}</div>
                </div>
                <div>
            ...
            <div className="inline-flex flex-col items-end pb-0 gap-1 h-1/2 w-full mt-2">
                <div className="text-sm tz-text-gray text-left w-full capitalize">{accountName}</div>
                <div className="flex items-center gap-3 w-full">
                    <div className="text-xl font-semibold tz-text-dark-1 capitalize">{accountNumber}</div>
