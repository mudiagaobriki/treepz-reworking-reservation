                ...
                <div className="relative w-full max-w-2xl max-h-full">
                    ...
                    <div className="bg-white rounded-2xl shadow w-[37.5rem]">
                        ...
                        <div className="w-full pt-14 pb-20 px-8">
                            ...
                            <h3 className="text-2xl font-semibold text-center self-stretch mb-3 tz-text-dark">Mercedes Maybach 2022</h3>
                            <p className="text-sm text-center self-stretch mb-10 tz-text-gray-3">We’ve sent your offer to the driver, you’ll get feedback in a 10 minutes</p>
